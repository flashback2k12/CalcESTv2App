...
public class AuswertungsdateiEV {
	...
	public static void erstelle(String l01, String l02, String l03, String l04, String l05, String l06, String l07, String l08, String l09, String l010, String l011, String l012, String l013, String l014){
		
		String FolderDir = " ";
/*
 * Prüfung der Android Version wegen unterschiedlicher Speicherort
 */		
...
/*
 * Prüfung ob Ordner verhanden ist, wenn nicht Ordner erstellen
 */
		try {
			...
			{
			newDir.mkdir();
			Toast.makeText(null, "Folder wurde erstellt", Toast.LENGTH_SHORT).show();
			}
/*
